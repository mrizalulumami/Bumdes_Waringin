<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-9">
            <?= form_open_multipart('admin/editdatapeminjam'); ?>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="nik" name="nik" value="<?= $data_peminjam['nik']; ?>">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-5">
                    <input type="text" class="form-control" id="tempat" name="tempat" value="<?= $data_peminjam['tempat']; ?>">
                    <?= form_error('tempat', '<small class="text-danger pl-3">,</small>'); ?>
                </div>
                <div class="col-sm-5">
                    <input type="text" class="form-control datepicker" id="ttl" name="ttl" value="<?= $data_peminjam['ttl']; ?>">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="alamat" name="alamat" value="<?= $data_peminjam['alamat']; ?>">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-3">
                    <input type="text" class="form-control" id="total" name="total" value="<?= $data_peminjam['total']; ?>">
                    <?= form_error('total', '<small class="text-danger pl-3">,</small>'); ?>
                </div>
                <label for="name" class="col-sm-1 col-form-label">Ket.</label>
                <div class="col-sm-6">
                    <input type="text" class="form-control" id="ket" name="ket" value="<?= $data_peminjam['ket']; ?>">
